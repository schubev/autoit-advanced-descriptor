...
function descriptorTagged(title, className, regexpTitle, regexpClassName, last, active, x, y, w, h, instance) {
...
function descriptor(windowDescription) {
  ...
  return descriptorTagged(title, className, regexpTitle, regexpClassName, last, active, x, y, w, h, instance);
}
